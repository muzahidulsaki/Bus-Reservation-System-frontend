...
export default function CounterAuth() {
  ...
  const [registerForm, setRegisterForm] = useState({ name: "", email: "", counterLocation: "", password: "", confirmPassword: "" });
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post("http://localhost:5000/login/counter", loginForm);
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/register/counter", registerData);
